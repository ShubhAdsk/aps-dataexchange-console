...
{
    /// <summary>
    /// What you learn: A design is a definition element plus CreateDesignRef.
    /// SDK: ElementDataModel.CreateDesignRef.
    /// Console plumbing: DesignSampleHelper.CreateOrGetDesignRefInteractiveAsync.
    /// Prerequisites: 2.2 Load Exchange.
    /// </summary>
    [SampleAddress(6, 1)]
    public sealed class CreateDesignRefSample : ISample
    {
        public string Name => "Create Design Ref";
